...
def main():
    ...
    # Загрузка модели
    model_path = os.path.join(config['models']['models_path'], "LinearRegression.pkl")
    ...
    metrics_file = os.path.join(reports_dir, "LinearRegression_metrics.json")
    with open(metrics_file, "w", encoding="utf-8") as f:
        json.dump(all_metrics, f, indent=4, ensure_ascii=False)

    # Логирование с DVCLive
    with Live(dir="dvclive/LinearRegression", save_dvc_exp=True) as live:
