...
На основе сводной таблицы метрик определена **лучшая модель** – **CatBoost**. Она показала минимальные значения ошибок (MAE, RMSE) и максимальный коэффициент детерминации (R²).
